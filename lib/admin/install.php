...
<head>
    ...
    <title>溯雪-系统安装</title>
    <link rel="shortcut icon" href="<?php echo HOME;?>lib/style/logo.png"/>
	<link rel="stylesheet" href="<?php echo HOME;?>lib/style/admin.css"/>
</head>
<body style="background:#fff;">
	<div class="header" style="height:60px;padding-left:50px;background:#353535;padding-bottom:0;">
		<div class="header-title">溯雪-系统安装</div>
	</div>
