...
<div class="tip">一共<span>{$ext.count}</span>个扩展 <span> · </span> 已安装<span>{$ext.installCount}</span>个扩展 · <a href="javascript:SX.import('ext')" class="red">导入扩展</a><!-- hook.admin_ext_menu --></div>
	...
	<li class="ext-uninstall">
		...
		<div class="ext-info">
			<div class="ext-name">
				...
				<a href="{url admin/ext/download/$item.id}" data-pjax="false" class="tpl-btn bg-orange">导出</a>
